...
export class ContentStreamer {
  ...
  readonly loader: ContentLoader, readonly config: ContentConfigurator) {}
  
  /** The content data snapshot */
  get data(): any { return this.loader.cache; }// this.route.snapshot.data; }

  /** The content data observable */
  get data$(): Observable<any> { return this.loader.data$; }// this.route.data; }
  ...
  public stream(selector: string = ''): Observable<any> {
    return this.data$.pipe( tap( data => console.log(data) ), map( data => this.select(selector, data) ) );
  }
